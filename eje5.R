...
# Definir paleta de colores para grÃ¡ficos.
...
# Se busca el tamaño de la muestra para conseguir los valores estipulados para los factores de la prueba:
...
# 4
# Considerando un volumen medio de 10 litros, ¿cuántos bidones deberían revisarse para conseguir un poder
# estadístico de 0,8 y un nivel de significación de 0,05?
